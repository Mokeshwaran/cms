    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              const Text('Welcome To CAMS', style: help_textstyle_welcome),
              ...
              Text(
                  bullet +
                      ' If you want to access the list of classes then click on Classes on the home page, you\'ll be presented with the only option \'Add\' click on it, add a class.',
                  style: help_textstyle),
              const SizedBox(height: 10.0),
              Text(
                  bullet +
                      ' After creating a class, if you want to update it, then tap that class, rename and update it!',
                  style: help_textstyle),
              const SizedBox(height: 10.0),
              Text(
                  bullet +
              ...
              Text(
                  bullet +
                      ' After assigning to a class, you can either manually resign or the timer fucntion will take care of it. But, the app must not be closed. This timer function will remind 5 minutes before the class ends, so that you can assign yourself to other class.',
                  style: help_textstyle),
              const SizedBox(height: 10.0),
              Text(
                  bullet +
                      ' If you want to delete your account, then goto Users -> Delete, tap on it, enter your password and you have successfully deleted your account. Thank You!',
                  style: help_textstyle),
              const SizedBox(height: 10.0),
              const Text('Now you can continue to use this app!!!',
                  style: help_textstyle),
              const SizedBox(height: 10.0),
            ],
          ),
